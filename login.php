    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      if (recoveryOptions) {
        recoveryOptions.forEach(option => {
          option.addEventListener('click', function() {
            ...
            if (selectedMethod === 'code' && recoveryCodeInput) {
      ...
      if (forgotPasswordForm) {
        forgotPasswordForm.addEventListener('submit', function(e) {
          ...
          // Envoi de la demande de réinitialisation au serveur
          ...
          .then(response => {
            ...
            if (!contentType || !contentType.includes('application/json')) {
              throw new Error('Format de réponse invalide (non-JSON)');
            }
            ...
            if (data.success) {
              ...
              switch(selectedMethod) {
                ...
                case 'code':
                  ...
                  // Si un token est retourné, rediriger vers la page de réinitialisation
                  if (data.token) {
                    setTimeout(() => {
              ...
              Swal.fire({
                ...
                // Masquer le modal après confirmation
                forgotPasswordModal.classList.add('hidden');
              });
            } else {
              Swal.fire({
          ...
          .catch(error => {
            ...
            Swal.fire({
              ...
              text: 'Une erreur est survenue lors de la communication avec le serveur: ' + error.message,
              icon: 'error',
              confirmButtonColor: '#10b981'
            });
          });
